import re
import logging
from score import sentence_similarity
...
class EvidenceScore:
    def __init__(self, ss_weights, weight_list=(0.2, 0.1, 0.1)):
        # 初始化评分权重，evidence list
        self.ss_weights = ss_weights
    ...
    def similarity_score(self,question1,evidence1):
        ...
        score = sentence_similarity.combination_sim(self.ss_weights, question1, evidence1) * self.similarity_weight
