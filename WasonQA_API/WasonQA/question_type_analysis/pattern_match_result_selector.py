...
"""
模式匹配结果选择器
原DeepQA的方式是逐个找类型模式文件的匹配结果，如果第一个文件有结果就直接返回
"""
...
class PatternMatchResultSelector:
    ...
    def select(question1, pattern_match_result):
        ...
        question1.question_type = QuestionType.Solution
        return question1
